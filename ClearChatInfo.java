...
import de.cryt4x.clearchat.main.Main;
...
public class ClearChatInfo implements CommandExecutor //implements Command class
{
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
	{
		if (sender instanceof Player) //When you use this command InGame
		{
			...
			if (args.length == 0)
			{
				...
				player.sendMessage("§d||§e Author: §cCryT4x §a(Idea: byWadim | Helped by kingkong329)");
			...
			String info[] = 
				{
					...
					"CryT4x (Idea: byWadim) | Helped by kingkong329)"
				};
